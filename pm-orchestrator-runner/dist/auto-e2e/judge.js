...
exports.JUDGE_SYSTEM_PROMPT = void 0;
exports.judge = judge;
exports.judgeBatch = judgeBatch;
exports.containsQuestions = containsQuestions;
...
exports.JUDGE_SYSTEM_PROMPT = JUDGE_SYSTEM_PROMPT;
/**
...
async function judge(input, config) {
    ...
    try {
        const responseText = await callOpenAI(JUDGE_SYSTEM_PROMPT, judgePrompt, config.judgeModel);
 ...
 */
async function judgeBatch(inputs, config) {
    const results = [];

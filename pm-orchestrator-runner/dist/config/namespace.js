...
exports.deriveNamespaceFromPath = deriveNamespaceFromPath;
 ...
 */
function getTableName(_namespace) {
    // v2: Single table design - all namespaces share the same table
    return queue_store_1.QUEUE_TABLE_NAME;
}
/**
 ...
 */
function generatePathHash(fullPath) {
 ...
 */
function deriveNamespaceFromPath(projectPath) {

...
exports.TestIncompleteExecutor = void 0;
exports.getTestExecutorMode = getTestExecutorMode;
exports.wrapWithTestExecutor = wrapWithTestExecutor;
/**
 * Get test executor mode from environment
 */
function getTestExecutorMode() {
 ...
 */
class TestIncompleteExecutor {
    innerExecutor;
    mode;
    constructor(innerExecutor, mode) {
...
exports.TestIncompleteExecutor = TestIncompleteExecutor;
/**
 * Wrap an executor with test capability
 * Only wraps if PM_TEST_EXECUTOR_MODE is set
 */
function wrapWithTestExecutor(executor) {
...
//# sourceMappingURL=test-incomplete-executor.js.map
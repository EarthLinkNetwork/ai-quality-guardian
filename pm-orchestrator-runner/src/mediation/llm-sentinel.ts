...
export class LLMSentinel {
   ...
   */
  private checkIntegrity(evidence: LLMEvidence): IntegrityCheckResult {
 ...
 */
export function createSentinel(evidenceDir: string): LLMSentinel {
 ...
 */
export function verifyLLMEvidence(evidenceDir: string): SentinelVerificationResult {
